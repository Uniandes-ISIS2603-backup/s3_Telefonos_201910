...
public class CelularResource {
    ...
    public CelularDTO createCelular(CelularDTO celular) throws BusinessLogicException {
        LOGGER.info("En createCelular Resource"); 
         CelularEntity entity = celular.toEntity();
        CelularDTO r = new CelularDTO(logica.createCelular(entity));
        return r;
    }
    ...
    /**
     * Actualiza el celular con el imei ingresado por parametro con los valores
     * del celular ingresado por parametro
     *
