...
import co.edu.uniandes.csw.telefonos.resources.PublicacionResource;
import java.io.File;
...
public class PublicacionIT {
    ...
    private static final String COLLECTION = "publicacionPostmanTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "frontstepbystep-api.war")//War del modulo api
                ...
                .addPackage(PublicacionResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(PublicacionDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
