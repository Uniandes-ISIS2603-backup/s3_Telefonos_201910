 ...
 */
package co.edu.uniandes.csw.telefonos.tests.postman;

import co.edu.uniandes.csw.postman.tests.PostmanTestBuilder;
import co.edu.uniandes.csw.telefonos.dtos.MetodoDePagoDTO;
import co.edu.uniandes.csw.telefonos.mappers.BusinessLogicExceptionMapper;
import co.edu.uniandes.csw.telefonos.resources.MetodoDePagoResource;
import java.io.File;
...
public class MetodoDePagoIT {
    private static final String COLLECTION = "metodoDePagoPostmanTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "frontstepbystep-api.war")//War del modulo api
                ...
                .addPackage(MetodoDePagoResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(MetodoDePagoDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
